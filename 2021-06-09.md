...
* [facebookresearch/flores (0s/0f)](https://github.com/facebookresearch/flores) : Facebook Low Resource (FLoRes) MT Benchmark
...
* [xnianq/cve-2021-21985_exp (0s/0f)](https://github.com/xnianq/cve-2021-21985_exp) : cve-2021-21985 exploit
...
* [undergroundwires/Azure-in-bullet-points (0s/0f)](https://github.com/undergroundwires/Azure-in-bullet-points) : ☁️ Azure summary in bullet points
...
* [secdev/scapy (0s/0f)](https://github.com/secdev/scapy) : Scapy: the Python-based interactive packet manipulation program & library. Supports Python 2 & Python 3.
...
* [KibaeKim/SectorTradingAlgorithm (0s/0f)](https://github.com/KibaeKim/SectorTradingAlgorithm) : 
...
* [longzhuzhu/nianyu (0s/0f)](https://github.com/longzhuzhu/nianyu) : 
* [d3/d3 (0s/0f)](https://github.com/d3/d3) : Bring data to life with SVG, Canvas and HTML. 📊📈🎉
* [google-map-react/google-map-react (0s/0f)](https://github.com/google-map-react/google-map-react) : Google map library for react that allows rendering components as markers 🎉
...
* [Budibase/budibase (0s/0f)](https://github.com/Budibase/budibase) : Budibase is an open-source low code platform that helps you build and self-host internal tools in minutes 🚀
* [earthchie/DeFi-SDK (0s/0f)](https://github.com/earthchie/DeFi-SDK) : 
...
* [elecV2/elecV2P (0s/0f)](https://github.com/elecV2/elecV2P) : 一款基于 NodeJS，可通过 JS 修改网络请求，以及定时运行脚本或 SHELL 指令的网络工具。
...
* [BanDev/Lux (0s/0f)](https://github.com/BanDev/Lux) : Lux is a command-line interface for controlling and monitoring Govee lighting strips built in Go.
...
* [golang/crypto (0s/0f)](https://github.com/golang/crypto) : [mirror] Go supplementary cryptography libraries
...
* [twostraws/whats-new-in-swift-5-5 (0s/0f)](https://github.com/twostraws/whats-new-in-swift-5-5) : 
...
* [foamzou/ITraffic-monitor-for-mac (0s/0f)](https://github.com/foamzou/ITraffic-monitor-for-mac) : Monitor for displaying process traffic on Mac Status bar
...
* [microsoft/electionguard (0s/0f)](https://github.com/microsoft/electionguard) : ElectionGuard is a set of open source software components that can be used to create and publish end to end verifiable elections as well create a publishable artifact for ballot comparison audits.
